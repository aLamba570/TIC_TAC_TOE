...
public class MainActivity extends AppCompatActivity {
    ...
    public EditText playr1;
    public EditText playr2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playr1 = (EditText) findViewById(R.id.playerone);
        playr2 = (EditText) findViewById(R.id.playertwo);
        ...
        playr1.addTextChangedListener(new TextWatcher(){
            @Override
        ...
        playr2.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
    ...
    private void addItemToDifficultySpinner() {
            ...
            if(checked){
                switch (view.getId()){
                    ...
                    case R.id.splayer:
                        ...
                        playr1.setImeOptions(EditorInfo.IME_ACTION_DONE);
                        playr1.setImeActionLabel("DONE", EditorInfo.IME_ACTION_DONE);
                    ...
                    case R.id.tplayer:
                        ...
                        playr2.setText(cloneplayer2);
                        playr1.setImeOptions(EditorInfo.IME_ACTION_NEXT);
                        playr1.setImeActionLabel("NEXT", EditorInfo.IME_ACTION_NEXT);
                        difficulty.setEnabled(false);
                        break;
                }
            }
